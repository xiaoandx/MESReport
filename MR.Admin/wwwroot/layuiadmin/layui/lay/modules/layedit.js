...
layui.define(['layer', 'form', 'code'], function (exports) {
    ...
    var $ = layui.$
        ...
        , Edit = function () {
            ...
            that.config = {
                //默认工具bar
                tool: [
                    'html', 'undo', 'redo', 'strong', 'italic', 'underline', 'del', 'addhr', '|', 'fontfamily', 'fontSize', 'fontBackColor', 'colorpicker', 'face'
                    , '|', 'left', 'center', 'right', '|', 'link', 'unlink', 'images', 'image_alt', 'video', 'attachment', '|', 'fullScreen', 'preview'
                ]
                , uploadImage: {
                    url: ''
                    , done: function (data) {
    ...
    var setIframe = function (editor, textArea, set) {
        ...
        , tools = {
            ...
            , fontfamily: '<i class="layui-icon layedit-tool-fontfamily" title="字体" layedit-event="fontfamily" style="font-size:18px">T</i>'
            , fontSize: '<i class="layui-icon layedit-tool-fontSize" title="字体大小" layedit-event="fontSize" style="font-size:18px">Aa</i>'
            , addhr: '<i class="layui-icon layedit-tool-addhr" title="添加水平线" layedit-event="addhr" style="font-size:18px">——</i>'
